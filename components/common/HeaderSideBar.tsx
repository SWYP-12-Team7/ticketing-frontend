    ...
    subcategories: [
      {
        id: "exhibition-all",
        label: "전체보기",
        href: "/search?type=EXHIBITION",
        icon: AllIcon,
      },
      {
        id: "exhibition-art",
        label: "현대미술",
        href: "/search?type=EXHIBITION&category=현대미술",
        icon: ContemporaryArtIcon,
      },
      {
        id: "exhibition-photo",
        label: "사진",
        href: "/search?type=EXHIBITION&category=사진",
        icon: PhotoIcon,
      },
      {
        id: "exhibition-design",
        label: "디자인",
        href: "/search?type=EXHIBITION&category=디자인",
        icon: DesignIcon,
      },
      {
        id: "exhibition-illustration",
        label: "일러스트",
        href: "/search?type=EXHIBITION&category=일러스트",
        icon: IllustIcon,
      },
      {
        id: "exhibition-painting",
        label: "회화",
        href: "/search?type=EXHIBITION&category=회화",
        icon: PaintingIcon,
      },
      {
        id: "exhibition-sculpture",
        label: "조각",
        href: "/search?type=EXHIBITION&category=조각",
        icon: SculptureIcon,
      },
      {
        id: "exhibition-installation",
        label: "설치미술",
        href: "/search?type=EXHIBITION&category=설치미술",
    ...
    subcategories: [
      {
        id: "popup-all",
        label: "전체보기",
        href: "/search?type=POPUP",
        icon: AllIcon,
      },
      {
        id: "popup-fashion",
        label: "패션",
        href: "/search?type=POPUP&category=패션",
        icon: FashionIcon,
      },
      {
        id: "popup-beauty",
        label: "뷰티",
        href: "/search?type=POPUP&category=뷰티",
        icon: BeautyIcon,
      },
      {
        id: "popup-fnb",
        label: "F&B",
        href: "/search?type=POPUP&category=F%26B",
        icon: FnBIcon,
      },
      {
        id: "popup-character",
        label: "캐릭터",
        href: "/search?type=POPUP&category=캐릭터",
        icon: CharacterIcon,
      },
      {
        id: "popup-tech",
        label: "테크",
        href: "/search?type=POPUP&category=테크",
        icon: TechIcon,
      },
      {
        id: "popup-lifestyle",
        label: "라이프스타일",
        href: "/search?type=POPUP&category=라이프스타일",
        icon: LifestyleIcon,
      },
      {
        id: "popup-furniture",
        label: "기구 & 인테리어",
        href: "/search?type=POPUP&category=기구%20%26%20인테리어",
        icon: FurnitureIcon,
      },
    ],
  },
